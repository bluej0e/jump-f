...
import SpeakerBack from "components/SpeakerBack/SpeakerBack.jsx";
    ...
    return (
      ...
      <Parallax id="paraBod" filter image={require("assets/img/bg7.jpg")}>
        ...
        <div className={classNames(classes.main, classes.mainRaised)}>
          ...
          <SpeakerBack image={require("assets/img/sign2.jpg")}>
            <div  className={classes.container}>
              <GridContainer>
                <GridItem
                  xs={12}
          ...
          <div className={classNames(classes.main, classes.mainRaised)} style={{marginTop:'-10em'}}>
            <SectionPills />
              <div className={classes.container}>
                <GridContainer>
                  <GridItem
